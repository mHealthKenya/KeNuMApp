				...
				<ScrollView
					...
					<View className='mt-10'>
						...
						<View className='p-2 flex flex-col'>
							<View>
								...
								MAK, founded in 2016, is a non-profit representing Kenyan midwives. Registered under the Societies Act (No. 48354), MAK is committed to advancing and revitalizing the midwifery profession in Kenya. As a member of ICM, ECSACON, and KHPS, MAK collaborates globally and regionally to enhance midwifery standards.
								</Text>
							</View>
						</View>
					</View>
					<View className='mt-10'>
						...
						<View className='p-2 flex flex-col'>
							<View>
								<Text className='tracking-wide text-base'>
								Welcome to our exclusive membership! Enjoy priority event access, special discounts, and personalized recommendations. Connect with like-minded individuals, expand your network, and access a plethora of benefits designed to enhance your experience with us. Welcome to a world of possibilities!
								</Text>
							</View>
						</View>
					</View>
					...
					<View className='mt-10'>
						...
						<ContentBox
							content={{
								...
								items: 'Discounted rates: Students and Customers pay 50% of the normal fee. Registration Fee: KES 500/- paid to the MAK National Office (New Members Only) Monthly Subscription KES 150/- will be payable to Equity Bank Ltd. account pay bill number. Note: Customer is a Community Member who advocates for midfery care.',
							}}
						/>
						<ContentBox
							content={{
								title: 'Payment Channels (MAK National Office)',
								items: 'Bank: Equity Bank Kenya Limited Branch: Upper Hill Branch BANK MPEAS Pay Bill Number: 247247 Account Pay Bill Number: 858951 Note: Once you make the payment, please send the details to admin@kenyamidwives.org',
							}}
						/>
					</View>
