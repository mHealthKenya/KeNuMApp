        ...
        {/* <View style={{ flex: 1 }}>
          <FlatList
            ...
            renderItem={({ item }) => (
              <Image
                source={item}
                style={{ width: 150, height: 50, marginRight: 10 }}
              />
            )}
          />
        </View> */}
        ...
        >
            ...
            <View className="p-2 flex flex-col">
              <View>
                <Text className="tracking-wide text-base">
                  The National Nurses Association of Kenya (NNA-Kenya) is a
                  professional association representing all cadres of nurses in
                  Kenya who are drawn from practice settings, education, and
                  research institutions. Established in 1968, we are duly
                  registered under Cap 108 of the laws of Kenya. We have
                  branches in all 47 counties across the country. We exist to
          ...
          <View className="mt-10">
            ...
            <View className="p-2 flex flex-col">
              <View>
                <Text className="tracking-wide text-base">
                  1. Download the relevant Registration form (Available on NNAK
                  website)
                </Text>
                <Text className="tracking-wide text-base">
                  2. Fill it out (Remember to sign it)
                </Text>
                <Text className="tracking-wide text-base">
                  3. Scan the Registration form
                </Text>

                <Text className="tracking-wide text-base">
                  4. Pay the registration fee to MPesa Paybill: 653080. The
                  account number is your ID Number
                </Text>
                <Text className="tracking-wide text-base">
                  5. Upload the form below
                </Text>
                <Text className="tracking-wide text-base">
                  6. Enter the MPesa Transaction code and send
                </Text>
