...
export enum OutMigrationGen {
	paid = 'paid',
}

export const outMigrationReceiptGen = (
	item: OutmigrationApplicationHistory,
	user: User | null,
	mode?: string
) => {
	const html = `
        ...
        <body>
            <table class="order-details">
                ...
                <tbody>
                    ...
                    <tr>
                        <td>Cadre:</td>
                        <td>${item.verification_cadres}</td>
