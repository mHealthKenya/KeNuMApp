...
const Transfer = () => {
	const {data: reasons = [], isLoading: reasonsLoading} = useTransferReasons();
	const {data: centers = [], mutate, isPending} = useInternshipCenters();
	...
	return <RequestTransferComponent centers={centers?.internship_centers} reasons={reasons} />;
};
